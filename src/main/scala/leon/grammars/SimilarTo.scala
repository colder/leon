 ...
 */
case class SimilarTo(e: Expr, terminals: Set[Expr] = Set(), sctx: SynthesisContext, p: Problem) extends SimpleExpressionGrammar {

  def computeProductions(label: TypeTree)(implicit ctx: LeonContext) = Nil
